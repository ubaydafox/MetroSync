      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-2xl shadow-lg p-6 border-l-4 border-blue-500 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-3xl font-bold text-gray-800 mt-1">{stats.total_departments}</h3>
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border-l-4 border-green-500 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-500 text-sm font-medium">HODs</p>
                <h3 className="text-3xl font-bold text-gray-800 mt-1">{stats.total_hods}</h3>
              </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border-l-4 border-orange-500 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-3xl font-bold text-gray-800 mt-1">{stats.total_batches}</h3>
              </div>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Link href="/dashboard/manage-departments">
              <div className="bg-white rounded-xl shadow-md p-4 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 group cursor-pointer">
            ...
            <Link href="/dashboard/manage-hods">
              <div className="bg-white rounded-xl shadow-md p-4 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 group cursor-pointer">
                <div className="flex flex-col items-center text-center">
                  ...
                  <span className="text-sm font-medium text-gray-700">Assign HOD</span>
                </div>
              </div>
            </Link>
            ...
            <Link href="/dashboard/manage-batches">
              <div className="bg-white rounded-xl shadow-md p-4 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 group cursor-pointer">
                <div className="flex flex-col items-center text-center">
                  ...
                  <span className="text-sm font-medium text-gray-700">Manage Batches</span>
                </div>
              </div>
            </Link>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            ...
            <div className="space-y-4">
              {departments.map(dept => (
                <div key={dept.id} className="bg-linear-to-r from-blue-50 to-indigo-50 rounded-xl p-5 border border-blue-100 hover:shadow-md transition-all duration-300">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 mt-1">HOD: {dept.hod_name}</p>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            ...
            <div className="space-y-4">
              {hods.map(hod => (
                <div key={hod.id} className="bg-linear-to-r from-green-50 to-emerald-50 rounded-xl p-5 border border-green-100 hover:shadow-md transition-all duration-300">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <h3 className="font-semibold text-gray-800 text-lg">{hod.name}</h3>
                      <p className="text-sm text-gray-600 mt-1">{hod.department_name}</p>
                      <p className="text-xs text-gray-500 mt-2">{hod.email}</p>
