      ...
      <div className="flex items-center justify-between">
        ...
        <div className="relative hidden md:block w-64">
          ...
          <input
            type="text"
            placeholder="Search..."
            className="pl-10 pr-4 py-2 w-full border border-(--primary)/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-[var(--primary)]/20 focus:border-[var(--primary)]"
          />
        </div>
